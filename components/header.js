class Header extends HTMLElement {
  ...
  <a class="logo" href="home.html">
    <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 16 16" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M8 16L3.54223 12.3383C1.93278 11.0162 1 9.04287 1 6.96005C1 3.11612 4.15607 0 8 0C11.8439 0 15 3.11612 15 6.96005C15 9.04287 14.0672 11.0162 12.4578 12.3383L8 16ZM3 6H5C6.10457 6 7 6.89543 7 8V9L3 7.5V6ZM11 6C9.89543 6 9 6.89543 9 8V9L13 7.5V6H11Z" fill="#FFF"/>
    </svg>
  </a>
  ...
  <div class="loginSign">
    ...
    <button class="order" aria-label="Toggle Orders">
      Захиалгууд
      <div id="cartDropDown" class="dropDown">
        <my-orders id="orders"></my-orders>
      </div>
    </button>
    ...
    this.ordersElement = shadow.querySelector('#orders');
    ...
    const orderButton = shadow.querySelector('.order');
    orderButton.addEventListener('click', () => {
      const dropDown = shadow.querySelector('#cartDropDown');
